...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.location.href.includes("4970020")) {
    ...
    document.querySelector(".description").insertAdjacentHTML("beforeend", "<b><br>Zelle: rabbi@chabadgmu.com<br><a href='https://www.paypal.com/paypalme/chabadgmu'>Click here for PayPal</a><br><a href='https://cash.app/$chabadgmu'>Click here for Cashapp</a></b>");
  }
});
