...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.location.href.includes("5549418")) {
    ...
    document.querySelector(".fs-thank-you-body .fs-text").innerHTML = "Thank you for partnering with us in our joint mission to connect the Jewish GMU students to their past, present, and future! From strength to strength!<br><br>- Rabbi Ezra and Bracha";
    document.querySelector("div.jumbotron.fs-header h1 small").innerHTML = "<br>Chabad at George Mason University";
  }
});
