if (window.location.href.includes(6146943)) {
    ...
    const pageFunctions = () => {
        ...
        const sponsorSelections = "#id_5, #id_10, #id_23, #id_26, #id_28";
        ...
        photosDiv.innerHTML = `<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vRFKr8cLNAhBSiusAHLZulS9o7loPzrYabCxCZ7k2QOER18QMw-pKgf-ziXVybyLPqDHYdvdoTas4qz/embed?start=true&amp;loop=true&amp;delayms=1500" frameborder="0" allowfullscreen="" class="gallery"></iframe>`;
        document.querySelector("#cid_4").insertAdjacentElement("afterend", photosDiv);
